...
const cli = sade('fetch <url>', true)
	...
	.example('playbooks-transfer fetch vercel/vercel')
	.example('playbooks-transfer fetch vercel/vercel/examples/angular')
	.example('playbooks-transfer fetch vercel/vercel/examples/angular --destination ~/storage')
	.example(
		'playbooks-transfer fetch vercel/vercel/examples/angular --destination ~/storage --clone playbooks-community',
	)
	.action(fetchCommand);
